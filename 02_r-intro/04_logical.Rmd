...
<span style="color:white">Use the `fbi` data object to answer the following questions: </span>

- <span style="color:white">how many reports of Burglaries are there for California?
</span>
- <span style="color:white">which state had the highest rate of violent crimes in 2014? in 1961?
</span>
