---
title: "Stat 480: Working with factor variables"
...
The solutions to the your turns in this slide deck are available as:
```{r, eval=FALSE}
learnr:: run_tutorial("factors", package="yourturns480")
```
